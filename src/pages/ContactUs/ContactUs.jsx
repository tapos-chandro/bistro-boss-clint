    ...
    return (
        <div>
            ...
            <div className="my-10">
                ...
                <div className="grid grid-cols-1 gap-10 lg:grid-cols-3 px-28">
                    <div className="text-center">
                        <div className="flex justify-center bg-[#D1A054] py-3">
                            <MdPhoneInTalk className="text-3xl text-neutral-50" />
                        </div>
                        <div className="my-10">
                        <h1 className="text-2xl font-medium text-neutral-950">Phone</h1>
                    ...
                    <div className="text-center">
                        ...
                        <div className="my-10">
                        <h1 className="text-2xl font-medium text-neutral-950">ADDRESS</h1>
                        <p>+38 (012) 34 56 789</p>
                        </div>
                    </div>
                    <div className="text-center">
                        ...
                        <div className="my-10">
                        <h1 className="text-2xl font-medium text-neutral-950">WORKING HOURS</h1>
            ...
            <div className="bg-[#F3F3F3] flex justify-center py-20">
                ...
                <form ref={form} onSubmit={sendEmail}>
                    <label>Name</label><br/>
                    <input type="text" name="name" className="w-full px-5 py-3 my-3" placeholder="Enter your name"  required/><br/>
                    <label>Email</label><br/>
                    <input type="email" name="email" className="w-full px-5 py-3 my-3" placeholder="Enter your email"  required/><br/>
                    <label>Message</label><br/>
                    <textarea name="message"  className="w-full px-5 py-3 my-3" placeholder="Enter your message" required/><br/>
                    <div className="my-5">
